...
class App:
    def __init__(self, root):
        ...
        GLabel_361.place(x=10,y=300,width=323,height=45)
        ...
        GLabel_421.place(x=260,y=240,width=227,height=50)
        ...
        GLineEdit_110.place(x=480,y=250,width=89,height=30)
